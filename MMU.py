...
def get_instruction(shared_data, physical_addr):
  return shared_data.page_frames[physical_addr[0]][physical_addr[1]:physical_addr[1]+15]

def page_fault(page_table, virtual_addr, pointer_out, shared_data):
  page_table[pointer_out] = [virtual_addr[0], virtual_addr[1], 1]
